...
const Header = () => (
  <header className="header" style={{ display: 'flex', justifyContent: 'flex-start',alignContent:"cenetr", columnGap:"4vw", padding:"1vw 0px 1vw 2vw", width:"100%",height:"10vw",fontSize: '2vw', backgroundColor: 'black', boxShadow: '0 4px 8px rgba(0,0,0,0.2)', fontFamily: 'Arial, Helvetica, sans-serif', fontWeight: 'bold' }}>
